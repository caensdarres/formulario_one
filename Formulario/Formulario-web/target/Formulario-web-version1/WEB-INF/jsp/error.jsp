...
<body>
		<div class="container">
				  ...
				  <div class="panel panel-default">
				    <div class="panel-heading">Ocurri&oacute; un error al realizar la solicitud, es posible que: </div>
				    <div class="panel-body">
				    <ul>
				      <li>Tenga desactivado el JavaScript de su navegador.</li>
					  <li>El enlace del sitio haya caducado.</li>
					  <li>La direcci&oacute;n ingresada en su navegador no corresponde.</li>
					  <li>Haya omitido uno o varios campos obligatorios.</li>
					  <li>El tipo de archivo enviado no corresponda al requerido.</li>
					</ul>
				    </div>
